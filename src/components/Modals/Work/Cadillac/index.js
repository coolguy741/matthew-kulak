...
const Cadillac = ({ width, height, toolbar }) => {
    return (
        <Modal
            name={"Cadillac"}
            width={width}
        ...
        >
            ...
            <p className={styles.workDesc}>
                The website for the band Cadillac uses React Three Fiber and
                Sanity Studio, and is built on Next.js.
            </p>
            <h4>Tech Stack</h4>
...
export default connect(mapStateToProps)(Cadillac)
