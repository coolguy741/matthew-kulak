...
const About = props => {
    const anchorWidth = props.anchor.width
    const anchorHeight = props.anchor.height
    ...
    const xPos = Math.random() * (props.width - width)
    const yPos = Math.random() * (props.height - height - 135) // Screen height minus modal, toolbars
    const anchorX = props.anchor.left
    const anchorY = props.anchor.top
    ...
    return (
        ...
        //     handle=".handle"
        //     bounds="body"
        //     defaultPosition={{ x: anchorX, y: anchorY }}
        //     position={{
        //         x: props.isAboutOpen ? xPos : anchorX,
        //         y: props.isAboutOpen ? yPos : anchorY,
        //     }}
        //     {...dragHandlers}
        // >
        <motion.div
